// 在编辑器端，通过这个接口获取配置项和主题设置的多语言
const apiUrl = `https://zcl6.myshopline.com/admin/api/merchant-bff/editor/theme/67f6a875a6c0bf0f8ef55fb7/language-schema?language=zh-hans-cn`;
